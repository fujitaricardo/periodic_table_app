...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<ChemicalElement> getChemicalElementsList() {
        ...
        chemicalElements.add(new ChemicalElement("", "La", 0, 0f, ChemicalElement.Category.LANTHANIDES));
        ...
        chemicalElements.add(new ChemicalElement("", "Ac", 0, 0f, ChemicalElement.Category.ACTINIDES));
    ...
    private void addNullElements(ArrayList<ChemicalElement> chemicalElements, int n) {
        for (int i = 0; i < n; i++) {
